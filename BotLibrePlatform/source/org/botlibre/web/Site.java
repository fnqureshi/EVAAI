 ...
 */
public class Site {
	public static String VERSION = "8.5.7-2020-11-03";
...
//	public static String PYTHONSERVER = "http://app-py:6777/"; // Python URL for Docker
...
//	public static String PERSISTENCE_HOST = "app-db"; // Database host name for Docker
	...
	public static int MAX_TRANSLATION_API = 10000;
