...
@javax.servlet.annotation.WebServlet("/analytic-labels-upload")
@SuppressWarnings("serial")
@MultipartConfig
public class AnalyticLabelsUploadServlet extends BeanServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (download != null) {
				if (!bean.downloadNetworkLabels(response)) {
			...
			if (filePart != null && filePart.getContentType().equals("text/plain")) {
				...
				bean.saveLabelsNetwork(stream, fileName , filePart.getContentType());
			} else {
				throw new BotException("Please select the analytic labels file to upload");
			}
