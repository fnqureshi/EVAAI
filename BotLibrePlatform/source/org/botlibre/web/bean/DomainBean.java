...
public class DomainBean extends WebMediumBean<Domain> {
	...
	public boolean confirmPayment(String tx, String amt, String st, String cc, String domain_id, String payment_id, String date, String token) {
		AdminDatabase.instance().log(Level.INFO, "confirm payment " + "tx: "+ tx + " amt: " + amt + " st: " + st + " cc: " 
				+ cc + " domain_id: " + domain_id + " payment_id: " + payment_id);
		try {
			Domain domain = null;
			boolean reset = false;
			...
			if ((getWizardDomain() == null) || (getPayment() == null) || (getUser() == null)) {
				...
				if (initialPayment.isSubscription()) {
					AdminDatabase.instance().log(Level.INFO, "processing subscription payment");
			...
			AdminDatabase.instance().log(Level.INFO, "updated domain with " + domain.getAccountType());
