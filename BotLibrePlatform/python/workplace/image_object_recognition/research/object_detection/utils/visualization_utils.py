...
def visualize_boxes_and_labels_on_image_array(
  ...
  """
  Object_Detection_Result = collections.namedtuple("Object_Detection_Result",["label","score","color"])
  result = []
  Object_Detection_Coordinates = collections.namedtuple("Object_Detection_Result",["ymin","xmin","ymax","xmax"])
  coordinates = []
    ...
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if agnostic_mode:
          ...
          if set_color != "":
            box_to_color_map[box] = set_color
          else:
            box_to_color_map[box] = STANDARD_COLORS[classes[i] % len(STANDARD_COLORS)]
          print(class_name+" " + '{}%'.format(int(100*scores[i])) +" Color: " + box_to_color_map[box])
          result.append(Object_Detection_Result(class_name,str(int(100*scores[i])),box_to_color_map[box]))
          set_color = ""
  ...
  for box, color in box_to_color_map.items():
    ...
    #print("Object Detection - Coordinates of the image -")
    #print("Ymin: " + str(ymin) + " Xmin: " + str(xmin) + " Ymax: "+ str(ymax) + " Xmax: " + str(xmax))
    coordinates.append(Object_Detection_Coordinates(ymin,xmin,ymax,xmax))
    if instance_masks is not None:
  ...
  return coordinates, result, image
