  ...
  try:
    ...
    with tf.Session() as sess:
      ...
      for node_id in top_k: 
        ...
        save_results[human_string] = score
  except Exception as e:
    print(e)
    traceback.print_exc()
    return "<analytic-audio-response label=\"unknown\" confidence=\"0\"></analytic-audio-response>"
  return "<analytic-audio-response label=\""+list(save_results.keys())[0]+"\" confidence=\""+str("%.2f" % round(list(save_results.values())[0]* 100,2))+"\"></analytic-audio-response>"
