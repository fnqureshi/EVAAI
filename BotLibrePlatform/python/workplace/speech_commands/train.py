...
from workplace.speech_commands import input_data
from workplace.speech_commands import models
from tensorflow.python.platform import gfile



def train_audio(wanted_words, data_dir, train_dir, summaries_dir, model_architecture):
  # set vars
  data_url=''
  ...
  # setting up default learning rate.
  if "low_latency_svdf" == model_architecture:
      learning_rate = "0.01,0.005"
      print("Model: " + model_architecture)
      print("Rate: " + learning_rate)
  elif "low_latency_conv" == model_architecture:
...
'''if __name__ == '__main__':
  ...
  parser.add_argument(
      '--data_url',
      type=str,
      # pylint: disable=line-too-long http://download.tensorflow.org/data/speech_commands_v0.02.tar.gz
      default='',
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='bird,cat,dog,happy,visual,yes,zero',
