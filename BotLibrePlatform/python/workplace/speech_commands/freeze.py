...
def freeze(model_architecture, wanted_words, output_file, start_checkpoint):

  # Create the model and load its weights.
  sess = tf.InteractiveSession()
  create_inference_graph(wanted_words, sample_rate,
...
'''if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_file', type=str,default=os.getcwd()+'/train/my_frozen_graph.pb', help='Where to save the frozen graph.')
