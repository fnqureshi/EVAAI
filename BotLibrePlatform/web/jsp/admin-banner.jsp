	...
	<div id="admin-topper-banner" align="left">
		...
		<div class="toolbar">
						...
						<% if (bean.getInstance() == null || !bean.getInstance().isExternal()) { %>
							...
							<% if (loginBean.isAdmin()) { %>
								<tr class="menuitem">
									<td><a href="self.jsp" title="<%= loginBean.translate("Add, create, edit, import, and export scripting programs") %>" class="menuitem">
										<img src="images/script2.png" class="menu"/> <%= loginBean.translate("Scripts") %></a>
									</td>
								</tr>
							<% } %>
							...
							<tr class="menuitem">
								<td><a href="instance-stats.jsp" title="<%= loginBean.translate("View the bot's statistics and charts") %>" class="menuitem">
									<img src="images/analytics.png" class="menu"/> <%= loginBean.translate("Analytics") %></a>
								</td>
							</tr>
						<% } else { %>
							<tr class="menuitem">
			...
			<% if (bean.getInstance() == null || !bean.getInstance().isExternal()) { %>
				...
				<% if (loginBean.isAdmin()) { %>
					<a href="self.jsp" title="<%= loginBean.translate("Add, create, edit, import, and export scripting programs") %>"><img src="images/script2.png" class="admin-banner-pic"></a> 
				<% } %>
				...
				<a href="instance-stats.jsp" title="<%= loginBean.translate("View the bot's statistics and charts") %>"><img src="images/analytics.png" class="admin-banner-pic"></a>
