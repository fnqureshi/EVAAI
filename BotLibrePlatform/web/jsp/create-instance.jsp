...
<body>
	...
	<div id="contents">
		<div class="section">
			<h1><%= loginBean.translate("Create new thought network") %></h1>
			...
			<% } else { %>
				<form action="bot" method="post" class="message">
					...
					<span class="required"><%= loginBean.translate("Thought Network Name") %></span><br/>
					...
					<input class="required" id="template" type="text" name="template" placeholder='<%= loginBean.translate("type of thought network to create") %>' value="<%= bean.getTemplate() %>"/><br/>
					<script>
