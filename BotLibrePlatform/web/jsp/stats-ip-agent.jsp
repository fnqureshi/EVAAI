...
<head>
	...
	<title>IP Agent Stats - <%= Site.NAME %></title>
...
<body>
	...
	<div id="mainbody">
		<div id="contents">
			<div class="about">
				<h1>IP Agent Stats - <%= Utils.sanitize(loginBean.getSelectedStats()) %></h1>
				...
				<% } else { %>
					<table id="stats" class="tablesorter">
						...
						<tbody>
						<% for (IPStats stat : AdminDatabase.instance().getAllIPAgentStats(loginBean.getSelectedStats())) { %>
							<tr>
								<td><%= stat.date %></td>
