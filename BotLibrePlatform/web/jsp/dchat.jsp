...
// BEGIN -- Blur
var blur = 10; // Change for number if response to remove blur.
var blurIncrement = 1; // Change to increase blur decrement.
var avatarCanvas = document.getElementById("botplatformframeavatar-canvas");
var avatarDiv = document.getElementById("botplatformframeavatar-div");

 avatarDiv.style.filter = "blur(" + blur + "px)";

web.onresponse = function(message) {

if (blur > 0) {
	avatarDiv.style.filter = "blur(" + blur + "px)";
	blur = blur - blurIncrement;
} else {
	avatarDiv.style.filter = null;
}
// END -- Blur
