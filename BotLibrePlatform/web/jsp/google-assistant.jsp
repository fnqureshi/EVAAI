...
<head>
	...
	<meta name="description" content="Connect your network to Google Assistant"/>	
		...
		<div class="clearfix">
			<span class="dropt-banner">
				<img id="help-mini" src="images/help.svg"/>
					<div>
						<%= loginBean.translate("The Google Assistant tab allows you to connect your network to Google Assistant.") %><br/>
					</div>
	...
	<div id="contents">
		<div class="browse">
			...
			<% if (!botBean.isConnected()) { %>
				<p class="help">
					The Google Assistant tab allows you to connect your network to Google Assistant.
				</p>
				<br/>
			...
			<% } else { %>
				<p>
					<%= loginBean.translate("Please use with caution, you are not allowed to use your network for spam, or violate our terms.") %>
				</p>
				<p>
