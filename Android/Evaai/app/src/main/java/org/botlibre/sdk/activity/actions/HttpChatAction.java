	...
	protected void onPostExecute(String xml) {
		...
		try {
			...
			if (!MainActivity.disableVideo && !activity.videoError && this.response.isVideo()) {
				...
				} else if (!ChatActivity.customAvatarImage.equals("")) {
					this.response.avatar = ChatActivity.customAvatarImage;
					HttpGetImageAction.fetchImage(this.activity, ChatActivity.customAvatarImage, imageView);
				} else {
