...
public class TemplateImageListAdapter extends ArrayAdapter<WebMediumConfig> {

    Activity activity;

    public TemplateImageListAdapter(Activity activity, int resourceId, List<WebMediumConfig> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.nameView.setText(Utils.stripTags(config.alias));
