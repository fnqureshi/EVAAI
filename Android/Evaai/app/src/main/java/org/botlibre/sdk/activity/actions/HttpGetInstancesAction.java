...
import org.botlibre.sdk.activity.ChangeAvatarActivity;
...
public class HttpGetInstancesAction extends HttpUIAction {
	...
	public void onPostExecute(String xml) {
		...
		if (config.type.equals("Forum")) {
			...
			if (MainActivity.changeAvatar) {
				intent = new Intent(this.activity, ChangeAvatarActivity.class);
			} else {
			...
			if (this.CustomAvatar) {
				...
				intent.putExtra("dataCustomAvatar", false);
			}
